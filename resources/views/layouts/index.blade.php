...
<head>
    ...
    <title>Khách Sạn GALAXYNG</title>
                ...
                <header id="fh5co-header-section">
                    <div class="container">
                        <div class="nav-header">
                            ...
                            <h1 id="fh5co-logo"><a href="{{ route('website') }}">GALAXYNG</a></h1>
            ...
            <footer id="footer" class="fh5co-bg-color">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="copyright">
                                <p><small>&copy; 2024 Khách sạn GALAXYNG. <br>
                                        Thiết kế bởi <a href="#" target="_blank">Nhóm 0 - Khách sạn GALAXYNG</a></small></p>
                                <ul class="link">
                                    <li><small><a href="#">Nguyễn Hoàng Anh</a></small></li>
                                    <li><small><a href="#">Nguyễn Gia Bảo</a></small></li>
                                    <li><small><a href="#">Ngô Minh Duy</a></small></li>
                                    <li><small><a href="#">Nguyễn Đức Dũng</a></small></li>
                                    <li><small><a href="#">Nguyễn Ngọc Minh</a></small></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6">
